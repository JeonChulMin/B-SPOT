...
<div id = "login">
	...
	<form action="loginimpl.mc" method="POST" class = "signUp">
		<label for = "iid">ID</label>
		<input class = "signUpInput" type = "text" name ="id" placeholder = "ID" id = "iid"><br>
		<label for = "ipwd">PASSWORD</label>
		<input class = "signUpInput" type = "password" name ="pwd" placeholder = "Password" id = "ipwd"><br>
