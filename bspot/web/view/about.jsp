...
<head>
    <title>Camping a Travel Category Bootstrap Responsive Template | About :: W3layouts</title>
    <!-- Meta tag Keywords -->
    ...
    <div class="main-content inner" id="home">
        ...
        <header class="header">
            <div class="container">
                ...
                <nav class="py-3">
                    <div id="logo">
                        <h1> <a class="navbar-brand" href="main.jsp">Camping</a>
                        </h1>
                    </div>
                    ...
                    <ul class="menu mt-2">
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="features.jsp">Features</a>
                                </li>
                                <li><a href="gallery.jsp">Gallery</a>
                                </li>
                                <li><a href="features.jsp">Services</a>
                                </li>
                            </ul>
                        </li>
