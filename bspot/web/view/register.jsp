...
<div id = "register">
	...
	<form class = "signUp" action="registerimpl.mc" method="POST">
		<label for = "rid">ID</label>
		<input class = "signUpInput" type="text" name="id" placeholder = "ID" id = "rid"><br>
		<label for = "rpwd">PWD</label>
		<input class = "signUpInput" type="password" name="pwd" placeholder = "PASSWORD" id = "rpwd"><br>
		<label for = "rnm">NAME</label>
		<input class = "signUpInput" type="text" name="name" placeholder = "NAME" id = "rnm"><br>
